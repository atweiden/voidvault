...
constant %keymaps = Map.new(
    ...
    'fr-afnor'                            => '"French AZERTY AFNOR - The new azerty"',
    ...
    'ge'                                  => '"Georgian UTF-8 keymap for a 102 key keyboard"',
    'gr'                                  => '"Improved Greek QWERTY keymap"',
    'gr-pc'                               => '"Greek QWERTY keymap"',
    'hcesar'                              => '"Hcesar keyboard, for Portuguese language"',
    ...
    'sg-mac'                              => '"Swiss German keyboard layout for Mac"',
...
constant %locales = Map.new(
    ...
    'crh_RU'                => '"Crimean Tatar (Crimean Turkish) language locale for Russia"',
    ...
    'ltg_LV'                => '"Latgalian locale for Latvia"',
    ...
    'ssy_ER'                => '"Afar language locale for Eritrea (Saaho Dialect)"',
    'st_ZA'                 => '"Sotho locale for South Africa"',
    'su_ID'                 => '"Sundanese language locale for Indonesia"',
    ...
    'translit_emojis'       => '"Transliterations of emojis to ASCII smileys"',
